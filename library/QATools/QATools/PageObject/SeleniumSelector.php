...
class SeleniumSelector implements SelectorInterface
{
	...
	public function translateToXPath($locator)
	{
		...
		if ( $selector == How::CLASS_NAME ) {
			$locator = $this->_escaper->escapeLiteral(' ' . $locator . ' ');
		...
		elseif ( $selector == How::ID ) {
			return 'descendant-or-self::*[@id = ' . $this->_escaper->escapeLiteral($locator) . ']';
		}
		elseif ( $selector == How::NAME ) {
			return 'descendant-or-self::*[@name = ' . $this->_escaper->escapeLiteral($locator) . ']';
		}
